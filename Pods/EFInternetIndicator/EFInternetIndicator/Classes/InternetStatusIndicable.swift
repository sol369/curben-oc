...
extension InternetStatusIndicable where Self: UIViewController {
    ...
    public func startMonitoringInternet(backgroundColor: UIColor = UIColor.black , style: MessageView.Layout = .StatusLine , textColor: UIColor = UIColor.white, message: String = "Please, check your internet connection", remoteHostName: String = "relinns.com") {
