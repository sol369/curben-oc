...
+ (SKLocalPhoto * _Nonnull)photoWithImageURL:(NSString * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
+ (SKLocalPhoto * _Nonnull)photoWithImageURL:(NSString * _Nonnull)url holder:(UIImage * _Nullable)holder SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (SKPhoto * _Nonnull)photoWithImage:(UIImage * _Nonnull)image SWIFT_WARN_UNUSED_RESULT;
+ (SKPhoto * _Nonnull)photoWithImageURL:(NSString * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
+ (SKPhoto * _Nonnull)photoWithImageURL:(NSString * _Nonnull)url holder:(UIImage * _Nullable)holder SWIFT_WARN_UNUSED_RESULT;
@end
...
- (id <SKPhotoProtocol> _Nonnull)photoAtIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
...
- (void)toggleControls;
- (BOOL)areControlsHidden SWIFT_WARN_UNUSED_RESULT;
- (void)popupShareWithIncludeCaption:(BOOL)includeCaption;
- (NSInteger)getCurrentPageIndex SWIFT_WARN_UNUSED_RESULT;
@end
