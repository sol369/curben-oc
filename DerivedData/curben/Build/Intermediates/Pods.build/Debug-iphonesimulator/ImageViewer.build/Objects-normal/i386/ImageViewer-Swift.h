...
@interface AVPlayer (SWIFT_EXTENSION(ImageViewer))
@end


@interface CALayer (SWIFT_EXTENSION(ImageViewer))
@end


@interface CAShapeLayer (SWIFT_EXTENSION(ImageViewer))
@end
...
@property (nonatomic, copy) void (^ _Nullable programmaticallyClosedCompletion)(void);
...
- (void)close;
- (void)itemControllerDidFinishSwipeToDismissSuccessfully;
...
@interface UIApplication (SWIFT_EXTENSION(ImageViewer))
@end


@interface UIBezierPath (SWIFT_EXTENSION(ImageViewer))
@end


@interface UIButton (SWIFT_EXTENSION(ImageViewer))
@end


@interface UIColor (SWIFT_EXTENSION(ImageViewer))
- (UIColor * _Nonnull)shadeDarker SWIFT_WARN_UNUSED_RESULT;
@end
